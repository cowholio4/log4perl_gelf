# This Makefile is for the Log::Log4perl::Layout::GELF extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Log/Log4perl/Layout/GELF.pm]
#     AUTHOR => q[Jason Pope <cowholio4@gmail.com>]
#     BUILD_REQUIRES => {  }
#     LICENSE => q[perl]
#     NAME => q[Log::Log4perl::Layout::GELF]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], Log::Log4perl=>q[0] }
#     VERSION_FROM => q[lib/Log/Log4perl/Layout/GELF.pm]
#     clean => { FILES=>q[Log-Log4perl-Layout-GELF-*] }
...
NAME_SYM = Log_Log4perl_Layout_GELF
VERSION = 0.02
...
MAKE = make
FULLEXT = Log/Log4perl/Layout/GELF
BASEEXT = GELF
PARENT_NAME = Log::Log4perl::Layout
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Log/Log4perl/Layout/GELF.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Log/Log4perl/Layout
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Log/Log4perl/Layout
...
TO_INST_PM = lib/Log/Log4perl/Layout/GELF.pm

PM_TO_BLIB = lib/Log/Log4perl/Layout/GELF.pm \
...
DISTNAME = Log-Log4perl-Layout-GELF
DISTVNAME = Log-Log4perl-Layout-GELF-0.02
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Log/Log4perl/Layout/GELF.pm $(INST_MAN3DIR)/Log::Log4perl::Layout::GELF.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Log-Log4perl-Layout-GELF' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.02' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Log4perl for graylog2' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Jason Pope <cowholio4@gmail.com>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Log4perl for graylog2</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Jason Pope &lt;cowholio4@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Log/Log4perl/Layout/GELF.pm blib/lib/Log/Log4perl/Layout/GELF.pm 
